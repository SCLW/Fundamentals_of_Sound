...
|Leistungs-<br>nachweis<br>Basislehr-<br>veranstaltung         |X |   |(X)|(X)|(X)|(X)|   |(X)|(X)|
|Leistungs-<br>nachweis                                        |X | X |   |   |   |   |   |   | X |
|Leistungs-<br>nachweis<br>für KIT- und<br>Austausch-<br>studierende|X |(X)|(X)|(X)|(X)|(X)|(X)|(X)|(X)| 
